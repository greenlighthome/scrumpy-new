Template.privateMessageCreateEditableButton.rendered = function() {
    ...
    var recipientsUsername = this.data.username;
    ...
    if (Meteor.user().username != recipientsUsername) {
        $('.private-message-create-editable').editable({
            ...
            success: function(response, newValue) {
                if (newValue) {
                    var firstMessage = {'text': newValue.message, 'submitted': new Date(), 'author': Meteor.user().username};
                    var participants = [recipientsUsername];
